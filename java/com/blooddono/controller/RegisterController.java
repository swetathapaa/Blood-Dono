...
public class RegisterController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		System.out.println(" doPost was triggered!");
		try {
	...
	private String validateRegistrationForm(HttpServletRequest req) {
		...
		if (!ValidationUtil.isValidPhoneNumber(contact)) return "Phone number must be 10 digits and start with 98.";
	...
	private DonorModel extractDonorModel(HttpServletRequest req) throws Exception {
		...
		return new DonorModel(firstName, lastName, bloodGroup, dob, gender, email, contact, password);
	}
